...
#@testset "betnet.jl" begin
    ...
    @time transNetworkInference(tempfile="./bestNet/data/time_real_data.csv",SNPfile="./bestNet/data/SNP_real_data.csv",Contactfile="",genomeSize=100000, itr_MCMC=1000000, burn_in=0,subsample=1000, outputfile="parameter_sim_50.csv")
    
    # simulation data with/without contact network
    @time transNetworkInference(tempfile="./bestNet/data/TemporalData1_100.csv",SNPfile="./bestNet/data/SNP1_100.csv",Contactfile="",genomeSize=1000000, itr_MCMC=1000000, burn_in=0,subsample=1000, outputfile="parameter_betnet_nonet.csv")
